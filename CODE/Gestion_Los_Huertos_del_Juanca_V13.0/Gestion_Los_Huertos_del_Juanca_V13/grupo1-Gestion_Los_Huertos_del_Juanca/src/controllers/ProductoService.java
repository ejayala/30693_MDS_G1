...
public class ProductoService {
   private Frm_Principal vista;
    ...
    private void iniciarEventos() {
        ...
        vista.btn_catalogoVentas.addActionListener(e -> {
        Frm_CatalogoProductos catalogo = new Frm_CatalogoProductos(dao);
    ...
    private void seleccionarImagen() {
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            JOptionPane.showMessageDialog(vista, "Imagen seleccionada correctamente");
        }
    }
