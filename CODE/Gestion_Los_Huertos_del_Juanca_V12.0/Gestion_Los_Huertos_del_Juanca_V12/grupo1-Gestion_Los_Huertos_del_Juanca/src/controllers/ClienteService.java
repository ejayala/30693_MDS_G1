...
public class ClienteService {
    ...
    private void guardarCliente() {
        ...
        JOptionPane.showMessageDialog(vista, "Este cliente ya existe");
        return;
    }
    ...
    public void cargarTabla() {
        ...
        for (Cliente c : dao.listarClientes()) {
            // Solo se listan los clientes Activos; los Inactivos se gestionan
            // unicamente desde la ventana de Gestion de Clientes Inactivos.
