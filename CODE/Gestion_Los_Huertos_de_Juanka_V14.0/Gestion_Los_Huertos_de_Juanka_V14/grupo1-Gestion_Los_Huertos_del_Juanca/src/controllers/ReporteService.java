...
public class ReporteService {
    ...
    private void exportarDatosAExcel() {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            ...
            // Agrupación matemática limpia en caliente
            ...
            for (int i = 0; i < modeloTablaVentas.getRowCount(); i++) {
                ...
                // 🛠️ CORRECCIÓN: Limpieza de strings regional para comas decimales
                String precioStr = modeloTablaVentas.getValueAt(i, 5).toString().replace("$", "").trim().replace(",", ".");
                ...
                // 🛠️ OPTIMIZACIÓN: Acumulamos multiplicando directamente con reales para blindar el gráfico
