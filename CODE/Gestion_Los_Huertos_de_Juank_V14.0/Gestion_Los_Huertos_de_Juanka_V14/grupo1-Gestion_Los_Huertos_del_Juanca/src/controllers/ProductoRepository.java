...
public class ProductoRepository {
    ...
    public ArrayList<Producto> buscarProductosDisponibles() {
        ArrayList<Producto> disponibles = new ArrayList<>();
        for (Producto p : listarProductos()) {
            if ("Disponible".equalsIgnoreCase(p.getEstadoProducto())) {
                disponibles.add(p);
            }
        }
        return disponibles;
    ...
    public ArrayList<Producto> buscarProductosDisponiblesPorNombre(String criterio) {
        ArrayList<Producto> filtrados = new ArrayList<>();
        String filtro = criterio.toLowerCase().trim();
        for (Producto p : buscarProductosDisponibles()) {
            if (p.getNombreProducto().toLowerCase().contains(filtro)) {
                filtrados.add(p);
            }
        }
        return filtrados;
