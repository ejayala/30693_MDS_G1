...
public class Frm_VistaPreviaPDF extends JDialog {
    ...
    private void generarPDFReal(String rutaArchivo) throws Exception {
        ...
        // 🛠️ MODIFICACIÓN 1: Datos del negocio actualizados (Dueño)
        Paragraph datosNegocio = new Paragraph(
            "Cédula/RUC: 1709857039 | Celular: 0993613384\nQuito - Ecuador",
        ...
        // 🛠️ MODIFICACIÓN 2: Obtención del celular del cliente (usa getCelular() o getTelefono())
        String celularCliente = (clienteActual != null) ? clienteActual.getTelefono() : "No registrado";
    ...
    private void generarPlantillaFactura(Venta venta, Cliente cliente, ArrayList<DetalleVenta> detalles) {
        ...
        // 🛠| MODIFICACIÓN 2.3: Obtención del celular del cliente para HTML
        String celularCliente = (cliente != null) ? cliente.getTelefono() : "No registrado";
        ...
        // 🛠️ MODIFICACIÓN 1.2: RUC/Cédula y Celular actualizados en HTML preview
        html.append("  <div class='sub-header'>Cédula/RUC: 1709857039 | Celular: 0993613384</div>");
        ...
        // 🛠️ MODIFICACIÓN 2.4: Tabla de datos estructurada con celular del cliente en HTML preview
        ...
        html.append("      <td align='right'><b>Celular:</b> ").append(celularCliente).append("</td></tr>");
        html.append("  <tr><td colspan='2'><b>Dirección:</b> ").append(direccion).append("</td></tr>");
        html.append("</table>");
